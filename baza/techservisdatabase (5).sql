...
--
-- Host: 127.0.0.1
-- Czas generowania: 22 Mar 2022, 19:27
...
(49, 'Kasia', '$2b$10$TVbydJLaDWWn/mK18N4u2eK2XUbNkUrTCJhfhBPvlLqwWHVs4V8lm', 'user', 'Kasia', 'Nowicka', 'kasia@onet.pl', '654987321'),
(50, 'Admin', '$2b$10$wMh6qKgJVPilmFO25goCWu9iqMMzCsOT1rFvVfNCSyjCKd8IyzTpS', 'admin', 'Damian', 'Dobrzyński', 'ghast0007@gmail.com', '+48 506 527 440');
...
INSERT INTO `zamowienia` (`id_zamowienia`, `user_id`, `opis`, `user_img`, `kategoria`, `czy_zrealizowane`, `czy_zaplacone`, `data`) VALUES
...
(54, 49, 'Zalałam laptopa, nie włącza się ', '1647880704650-zalany.jpg', 'Laptopy', 1, 0, '2022-03-21 17:47:49'),
(55, 49, 'Matryca w monitorze mi się rozlała chciałbym wymienić matrycę na nową', '1647883164770-matryca.jpg', 'Inne', 1, 0, '2022-03-21 17:37:21');
...
--
ALTER TABLE `zamowienia`
  MODIFY `id_zamowienia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;
COMMIT;
